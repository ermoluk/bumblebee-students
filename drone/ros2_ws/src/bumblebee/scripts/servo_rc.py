...
"""
servo_rc.py -- RC channel 9 controls servo up/down.
  Button pressed  (CH9 > 1500 us) -> servo UP   (255)
  Button released (CH9 < 1500 us) -> servo DOWN (0)
...
class ServoRC(Node):
    ...
    def _cb(self, msg):
        ...
        self.get_logger().info(f'Servo: {state} (CH9={ch9}us, angle={angle})')
        self._last = state
